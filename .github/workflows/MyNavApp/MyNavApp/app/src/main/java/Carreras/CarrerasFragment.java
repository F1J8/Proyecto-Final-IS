...
public class CarrerasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if( Utilidades.Rotacion==0){
            ...
            if (appBar==null){
                ...
                viewPager = vista.findViewById(R.id.OpcionesCarreras);
                llenarvP (viewPager);
    ...
    private void llenarvP(ViewPager viewPager) {
        ...
        { adapter.addFragments(new AjustesCarreras(),"Servicios");
            adapter.addFragments(new Carreras(),"Lista de Servicios");
    ...
    /**Importante agregar esto para que no haya problemas con los tabs*/
    @Override
