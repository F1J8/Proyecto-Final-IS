...
public class Transferencia extends Fragment {
    ...
    public static Transferencia newInstance(String param1, String param2) {
    ...
    vista=inflater.inflate(R.layout.fragment_transferencia, container, false);
        /**Relacione TI*/
        ...
        Reingreso = vista.findViewById(R.id.btReingreso);
    
        Reingreso.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                aProspectosU();
            }
    ...
    private void aProspectosU(){
       ProspectosU fragment = new ProspectosU();
        FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
        fragmentTransaction.replace(R.id.frame_layout, fragment, "Reingreso");
    ...
    public void Registrar() {
        ...
        if (!validateDNI() | !validateNombre() | !validateApellido() | !validateCorreo() | !validateTel1() |
            ...
            db.insert("Prospectos_U_Transferencia", null, registro);
    ...
    public void Buscar(){
        ...
        if(!dni.isEmpty()){
            Cursor fila = db.rawQuery
                    ("select  Nombre, Apellido, Telefono1, Telefono2, Correo, Universidad, Carrera, Nivel  from Prospectos_U_Transferencia where DNI=" + dni, null);
    ...
    public void Eliminar(){
        ...
        if(!dni.isEmpty()){
            ...
            int cantidad = db.delete("Prospectos_U_Transferencia", "DNI=" + dni, null);
            db.close();
    ...
    public void Modificar(){
        ...
        if(   !dni.isEmpty() && !nombre.isEmpty() && !apellido.isEmpty() && !correo.isEmpty()
            ...
            int cantidad = db.update("Prospectos_U_Transferencia", registro, "DNI=" + dni, null);
            db.close();
            /**Verificar el limpiado de datos*/
            Nombre.setText("");
            DNI.setText("");
